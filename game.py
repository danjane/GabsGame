...
class Game:
    ...
    def create_monster_sprite(self, kind: str, step: int) -> pygame.Surface:
        ...
        pygame.draw.rect(sprite, (0, 0, 0, 45), (14, 53, 38, 5))

        bob = 1 if step == 1 else 0
        leg_step = 4 if step == 1 else 0
        if kind == "moss_cube":
            body = pygame.Rect(20, 23 + bob, 24, 27)
            head = pygame.Rect(16, 5 + bob, 32, 24)
            left_arm = pygame.Rect(11, 27 + bob + leg_step // 2, 8, 18)
            right_arm = pygame.Rect(45, 27 + bob - leg_step // 2, 8, 18)
            pygame.draw.rect(sprite, (54, 145, 64), left_arm)
            pygame.draw.rect(sprite, (54, 145, 64), right_arm)
            pygame.draw.rect(sprite, (69, 170, 78), body)
            pygame.draw.rect(sprite, (88, 194, 92), head)
            pygame.draw.rect(sprite, (31, 96, 43), left_arm, 2)
            pygame.draw.rect(sprite, (31, 96, 43), right_arm, 2)
            pygame.draw.rect(sprite, (31, 96, 43), body, 2)
            pygame.draw.rect(sprite, (31, 96, 43), head, 2)
            pygame.draw.rect(sprite, (25, 62, 31), (23, 13 + bob, 7, 7))
            pygame.draw.rect(sprite, (25, 62, 31), (35, 13 + bob, 7, 7))
            pygame.draw.rect(sprite, (22, 56, 28), (29, 21 + bob, 7, 6))
            pygame.draw.rect(sprite, (30, 70, 35), (27, 25 + bob, 3, 5))
            pygame.draw.rect(sprite, (117, 220, 110), (18, 7 + bob, 8, 5))
            pygame.draw.rect(sprite, (49, 128, 56), (38, 34 + bob, 6, 6))
            pygame.draw.rect(sprite, (94, 196, 90), (24, 42 + bob, 8, 5))
        else:
            body = pygame.Rect(19, 24 - bob, 26, 26)
            head = pygame.Rect(15, 6 - bob, 34, 24)
            left_arm = pygame.Rect(10, 29 - bob - leg_step // 2, 8, 16)
            right_arm = pygame.Rect(46, 29 - bob + leg_step // 2, 8, 16)
            pygame.draw.rect(sprite, (76, 62, 150), left_arm)
            pygame.draw.rect(sprite, (76, 62, 150), right_arm)
            pygame.draw.rect(sprite, (95, 78, 184), body)
            pygame.draw.rect(sprite, (125, 96, 222), head)
            pygame.draw.rect(sprite, (54, 43, 122), left_arm, 2)
            pygame.draw.rect(sprite, (54, 43, 122), right_arm, 2)
            pygame.draw.rect(sprite, (54, 43, 122), body, 2)
            pygame.draw.rect(sprite, (54, 43, 122), head, 2)
            pygame.draw.rect(sprite, (236, 250, 158), (22, 15 - bob, 7, 7))
            pygame.draw.rect(sprite, (236, 250, 158), (36, 15 - bob, 7, 7))
            pygame.draw.rect(sprite, (225, 205, 255), (28, 23 - bob, 9, 5))
            pygame.draw.rect(sprite, (151, 130, 238), (18, 9 - bob, 7, 5))
            pygame.draw.rect(sprite, (83, 68, 160), (39, 38 - bob, 7, 7))
            pygame.draw.rect(sprite, (143, 116, 230), (23, 43 - bob, 8, 5))

        foot_color = (45, 58, 48) if kind == "moss_cube" else (50, 45, 80)
        pygame.draw.rect(sprite, foot_color, (21, 49 + bob, 8, 8 - leg_step // 2))
        pygame.draw.rect(sprite, foot_color, (36, 49 + bob, 8, 4 + leg_step // 2))
        return sprite
