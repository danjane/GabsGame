...
class Game:
    ...
    def create_monster_sprite(self, kind: str, step: int) -> pygame.Surface:
        ...
        if kind == "moss_cube":
            head = pygame.Rect(14, 4 + bob, 36, 26)
            body = pygame.Rect(19, 30 + bob, 26, 21)
            left_arm = pygame.Rect(8, 29 + bob + step_offset, 10, 20)
            right_arm = pygame.Rect(46, 29 + bob - step_offset, 10, 20)
            ...
            pygame.draw.rect(sprite, (18, 48, 22), (29, 22 + bob, 9, 6))
            pygame.draw.rect(sprite, (12, 38, 18), (31, 27 + bob, 4, 5))
            pygame.draw.rect(sprite, (112, 220, 108), (17, 7 + bob, 8, 6))
            pygame.draw.rect(sprite, (112, 220, 108), (41, 8 + bob, 6, 7))
            pygame.draw.rect(sprite, (42, 116, 48), (38, 35 + bob, 7, 7))
            pygame.draw.rect(sprite, (92, 196, 88), (22, 43 + bob, 9, 6))
        else:
            head = pygame.Rect(13, 5 - bob, 38, 26)
            body = pygame.Rect(19, 31 - bob, 26, 20)
            left_arm = pygame.Rect(7, 30 - bob - step_offset, 10, 18)
            right_arm = pygame.Rect(47, 30 - bob + step_offset, 10, 18)
            ...
            pygame.draw.rect(sprite, (226, 205, 255), (29, 23 - bob, 9, 6))
            pygame.draw.rect(sprite, (158, 132, 240), (17, 8 - bob, 8, 6))
            pygame.draw.rect(sprite, (158, 132, 240), (42, 9 - bob, 6, 7))
            pygame.draw.rect(sprite, (78, 62, 152), (38, 38 - bob, 8, 7))
            pygame.draw.rect(sprite, (142, 114, 230), (22, 43 - bob, 9, 6))

        foot_color = (45, 58, 48) if kind == "moss_cube" else (50, 45, 80)
        pygame.draw.rect(sprite, foot_color, (20, 50 + bob, 10, 7 - step_offset // 2))
        pygame.draw.rect(sprite, foot_color, (36, 50 + bob, 10, 4 + step_offset // 2))
        return sprite
